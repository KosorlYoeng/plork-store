...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (toggleConfirmPasswordBtn) {
        toggleConfirmPasswordBtn.addEventListener('click', () => {
            Helpers.togglePasswordVisibility('confirmPassword', 'toggleConfirmPassword');
        });
    }
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            if (!firstName || !lastName || !username || !email || !role) {
                Helpers.showAlert('alert', 'Please fill in all required fields', 'error');
                return;
            }
            ...
            if (!Helpers.validatePassword(password)) {
                Helpers.showAlert('alert', 'Password must be at least 8 characters long', 'error');
                return;
            }
            ...
            if (!terms) {
                Helpers.showAlert('alert', 'Please accept the Terms of Service', 'error');
                return;
            }
